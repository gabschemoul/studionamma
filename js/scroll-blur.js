// CSS à ajouter dans votre feuille de style ou en ajoutant une balise style au début
      ...
      textBlurElements.forEach((element, index) => {
        try {
          ...
          if (!splitText.words || splitText.words.length === 0) {
            ...
            // Étape 3: Utiliser autoAlpha au lieu de opacity
            gsap.set(element, {autoAlpha: 1}); // Rendre visible en cas d'échec
            return;
          }
                  
          // 5. Appliquer les styles initiaux
          gsap.set(splitText.words, {
            autoAlpha: 0, // Étape 3: Utiliser autoAlpha au lieu de opacity
            x: 10,
            filter: 'blur(10px)'
          });
          ...
          if (isAlreadyVisible) {
            gsap.to(splitText.words, {
              autoAlpha: 1, // Étape 3: Utiliser autoAlpha au lieu de opacity
              x: 0,
              filter: 'blur(0px)',
              stagger: 0.05,
              duration: 0.5
